    ...
    Crear = async (req, res) => {
        try {
            ...
            let mailOption = {
                ...
                attachments: [
                    { filename: "registro.pdf", path: pdfPath },
                ],
            };
            ...
            const respuestas = [
                {
                    numPregunta: 1,
                    Pregunta:
                        "¿De cuántos jugadores pueden ser los equipo?",
                    respuesta: "6",
                },
                {
                    numPregunta: 2,
                    Pregunta:
                        "¿De qué otra forma se le llama al básquet bol?",
                    respuesta: "Baloncesto",
                },
                {
                    numPregunta: 3,
                    Pregunta:
                        "¿Cuantas posiciones hay en el básquetbol?",
                    respuesta: "18",
                },
                {
                    numPregunta: 4,
